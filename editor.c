...
void show_about(GtkWidget *widget, gpointer data) {
  ...
  gtk_about_dialog_set_name(GTK_ABOUT_DIALOG(dialog), "Mukt Editor\n Made By Rohith Srivathsav\n MIS : 111508059");
  gtk_about_dialog_set_comments(GTK_ABOUT_DIALOG(dialog), 
   "\nMukt Editor is a minimal text editor made with GTK+2.0 and C. \n");
...
int main(int argc, char *argv[]) {
  ...
  gtk_window_set_title(GTK_WINDOW(window), "Mukt Editor");
